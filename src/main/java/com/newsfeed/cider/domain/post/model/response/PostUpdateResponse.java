...
public class PostUpdateResponse {
    ...
    public PostUpdateResponse(Long id, String name, String communityName, String title, String content, Long likeCount, LocalDateTime createdAt, LocalDateTime modifiedAt) {
        this.id = id;
        this.name = name;
